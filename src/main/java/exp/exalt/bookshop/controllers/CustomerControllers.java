...
public class CustomerControllers {
  @Autowired
    ...
    public ResponseEntity<Object> rentBook(@PathVariable(value = "id") long id, @PathVariable(value = "isbn") long isbn) {
        return  new ResponseEntity<>(customerUtil.rentCustomerBook(id,isbn), HttpStatus.CREATED);
    }

    @DeleteMapping(value = "/{id}/books/{isbn}")
    public ResponseEntity<Object> returnCustomerBook(@PathVariable(value = "id") long id, @PathVariable(value = "isbn") long isbn) {
